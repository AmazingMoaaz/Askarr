    ...
    <>
      ...
      <div className="pl-lg-4">
        ...
        <Row>
          ...
          <Col lg="6">
            <a href="https://github.com/thomst08/Askarr/wiki/Configuring-Overseerr#configuring-permissions" target="_blank" rel="noreferrer">Click here to view how configure Overseerr permissions with the bot</a>
          </Col>
        </Row>
        <Row>
          <Col>
